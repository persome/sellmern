...
function Reviews() {
    return (
        <div className='grid grid-cols-3 gap-8 p-6 pb-16'>

            {/* <------------------- CARD 1 ---------------> */}

            <div className='block p-6 max-w-lg bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-900'>
                <article>
                    <div className="flex items-center mb-4 space-x-4">
                        <img className="w-10 h-10 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-3.jpg" alt="" />
